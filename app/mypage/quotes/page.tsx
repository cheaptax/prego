...
export async function generateMetadata(): Promise<Metadata> {
  const bundle = await loadPublishedCmsPage("member.quotes");
...
export default async function MyQuotesPage() {
  ...
  const [quotesBundle, signupBundle] = await Promise.all([
    loadPublishedCmsPage("member.quotes"),
